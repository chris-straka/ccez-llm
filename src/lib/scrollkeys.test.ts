...
describe("scrollHoldVelocity", () => {
	it("glides j/k at line speed and d/u three times faster", () => {
		...
		expect(SCROLLKEY_DU_VELOCITY_PX_S).toBe(3 * SCROLLKEY_JK_VELOCITY_PX_S);
		// Shifted spellings keep their delete jobs: no glide.
