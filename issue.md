...
preview. No window server available for traffic-light hover eyes;
unrelated.
...
- Cast-cleanup tail: finished (62afbad predecessors) — the only
  survivors now are narrow platform boundaries.
